...
namespace Shop.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        /// </summary>
        ///
        [Display(Name = "Текущая электронная почта")]
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "Отправлена ссылка для подтверждения изменения электронной почты. Пожалуйста, проверьте свою электронную почту.";
                return RedirectToPage();
            }

            StatusMessage = "Ваш e-mail не изменился.";
            return RedirectToPage();
        }
